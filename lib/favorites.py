...
from PyQt6.QtCore import QModelIndex, QPersistentModelIndex, QSettings
from PyQt6.QtGui import QKeySequence, QBrush, QShortcut
from PyQt6.QtWidgets import QDialogButtonBox, QKeySequenceEdit
